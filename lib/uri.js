...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'ozosbittglobal:') {
    throw new TypeError('Invalid ozosbittglobal URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid ozosbittglobal address');
  }
