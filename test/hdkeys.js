...
var HDPrivateKey = ozbcore.HDPrivateKey;
var HDPublicKey = ozbcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = ozbcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(ozbcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(ozbcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      ozbcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = ozbcore.PublicKey.fromPoint;
      ozbcore.PublicKey.fromPoint = function() {
        ozbcore.PublicKey.fromPoint = unstubbed;
