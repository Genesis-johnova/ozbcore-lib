...
var BufferWriter = ozbcore.encoding.BufferWriter;
var BufferReader = ozbcore.encoding.BufferReader;
...
describe('Output', function() {
  ...
  it('#toObject roundtrip will handle an invalid (null) script', function() {
    ...
    var br = new ozbcore.encoding.BufferReader(invalidOutputScript);
