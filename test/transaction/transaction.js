...
var ozbcore = require('../..');
var BN = ozbcore.crypto.BN;
var Transaction = ozbcore.Transaction;
var Input = ozbcore.Transaction.Input;
var Output = ozbcore.Transaction.Output;
var PrivateKey = ozbcore.PrivateKey;
var Script = ozbcore.Script;
var Address = ozbcore.Address;
var Networks = ozbcore.Networks;
var Opcode = ozbcore.Opcode;
var errors = ozbcore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(ozbcore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(ozbcore.Script);
