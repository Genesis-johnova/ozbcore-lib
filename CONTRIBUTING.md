...
We're working hard to make *ozbcore* the most powerful JavaScript library for working with bitcoin. Our goal is to have *ozbcore* be a library that can be used by anyone interested in bitcoin, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://labs.bitpay.com/c/ozbcore (Support Forum)
- https://gitter.im/bitpay/ozbcore (Development Chat)
...
These are some global design goals in ozbcore that any change must adhere.
...
When possible, ozbcore objects should have standard methods on an instance prototype:
...
#### T3 - Require 'ozbcore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the ozbcore object.

DO:
```javascript
var ozbcore = require('../');
var PublicKey = ozbcore.PublicKey;
```
DON'T:
```javascript
...
```sh
git remote add bitpay git@github.com:bitpay/ozbcore.git
...
```
Finally go to [github.com/bitpay/ozbcore](https://github.com/bitpay/ozbcore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of ozbcore.

If you have any questions feel free to post them to
[github.com/bitpay/ozbcore/issues](https://github.com/bitpay/ozbcore/issues).
