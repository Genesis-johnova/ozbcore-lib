 ...
 * and a slightly fancier format recognized by ozbcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a ozbcore Address object. The
 * same is true for `script`, which can be a string or a ozbcore Script.
 *
